...
- [Utilisation](./usage.md)
    - [Se déplacer dans l'interface](./usage.md#se-déplacer-dans-linterface)
        - [Les bases](./usage.md#les-bases)
        - [Ajuster l'affichage](./usage.md#ajuster-l'affichage)
    - [Les commandes de base](./usage.md#les-commandes-de-base)
        - [Gérer vos fichiers](./usage.md#gérer-vos-fichiers)
        - [Gérer vos commits](./usage.md#gérer-vos-commits)
        - [Gérer vos branches](./usage.md#gérer-vos-branches)
    - [Fonctions avancées](./usage.md#fonctions-avancées)
        - [Rebase interactif](./usage.md#rebase-interactif)
        - [Cherry-pick](./usage.md#cherry-pick)
        - [Stash](./usage.md#stash)
    - [Comprendre les couleurs de l'interface](./usage.md#comprendre-les-couleurs-de-linterface)
        - [Les commits](./usage.md#les-commits)
        - [Les raccourcis importants](./usage.md#les-raccourcis-importants)
    - [Conseils](./usage.md#conseils)
